...
const numberOfPeopleRejected = numberOfPeople - numberOfSeatsAvailable;
const peopleRejected = people.splice(-numberOfPeopleRejected);
...
// don't modify the 2 console.log() below
console.log(
...
const luckyWinnerIndex = Math.floor(Math.random() * numberOfPeopleRejected);
const luckyWinner = peopleRejected[luckyWinnerIndex];
console.log(`${luckyWinner} will be able to join the trip!`);
